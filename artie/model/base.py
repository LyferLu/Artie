...
from artie.schema import InpaintRequest, HDStrategy, SDSampler, Txt2ImgRequest
...
class DiffusionInpaintModel(InpaintModel):
    ...
    def txt2img(self, config: Txt2ImgRequest):
        """Text-to-image generation. Returns BGR image as numpy array [H, W, C].
        Override in subclasses that support txt2img.
        """
        raise NotImplementedError(
            f"{self.model_info.name} does not support text-to-image generation"
        )
